// Sajid Ahmed
// Final Lab - Recursion
// Power.java: Reads in 2 integers & uses a recursive power method to compute
// the 1st raised to the second power.
...
public class Power 
{
    ...
    public static int power(int base, int exp) // Computes and returns base^exp
    {
        int pow;
